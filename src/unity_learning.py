...
class DQN:
    ...
    def create_model(self):
        model = Sequential()
        model.add(Conv2D(64, kernel_size=(8,8), strides=(4, 4), padding='same', data_format="channels_last", input_shape=self.env.observation_space.shape))
...
for ep in range(episodes):
    ...
    if ep % 10 == 0:
        dqn_agent.save_model("trial-{}.model".format(ep))
